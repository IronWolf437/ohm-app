...
scroll_band1 = CTkScrollableDropdown(combobox_band1, values=list(color_band.keys()), justify="left", button_color="transparent", frame_corner_radius= 10)
scroll_band2 = CTkScrollableDropdown(combobox_band2, values=list(color_band.keys()), justify="left", button_color="transparent", frame_corner_radius= 10)
scroll_band3 = CTkScrollableDropdown(combobox_band3, values=list(color_band.keys()), justify="left", button_color="transparent", height=119, frame_corner_radius= 10)
scroll_Multiplier = CTkScrollableDropdown(combobox_Multiplier, values=list(multiplier.keys()), justify="left", button_color="transparent", height=119, frame_corner_radius= 10)
scroll_Tolerance = CTkScrollableDropdown(combobox_Tolerance, values=list(tolerance.keys()), justify="left", button_color="transparent", height=100, frame_corner_radius= 10)
scroll_PPM = CTkScrollableDropdown(combobox_PPM, values=list(ppm.keys()), justify="left", button_color="transparent", height=100, frame_corner_radius= 10)
...
scroll_bands = CTkScrollableDropdown(box_bands, values=list(type), justify="left", button_color="transparent", frame_corner_radius= 10)
scroll_tolrn = CTkScrollableDropdown(box_tolrn, values=list(tolerance_2), justify="left", button_color="transparent", frame_corner_radius= 10, height=120)
...
def mode():
    ...
    scroll_band1.configure(fg_color=color_scroll)
    scroll_band2.configure(fg_color=color_scroll)
    scroll_band3.configure(fg_color=color_scroll)
    scroll_Multiplier.configure(fg_color=color_scroll)
    scroll_Tolerance.configure(fg_color=color_scroll)
    scroll_PPM.configure(fg_color=color_scroll)
    scroll_bands.configure(fg_color=color_scroll)
    scroll_tolrn.configure(fg_color=color_scroll)
    scroll_color_btn.configure(fg_color=color_scroll)
    scroll_color_hbtn.configure(fg_color=color_scroll)
    scroll_color_tbtn.configure(fg_color=color_scroll)
...
def update_button():
    scroll_band1.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_band2.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_band3.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_Multiplier.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_Tolerance.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_PPM.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_bands.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_tolrn.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_color_btn.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_color_hbtn.configure(frame_border_color=col_b, hover_color=col_h)
    scroll_color_tbtn.configure(frame_border_color=col_b, hover_color=col_h)
...
# Create combobox in the frame:
box_color_btn = CTkComboBox(master=fram_color_btn, values=list(col_btn.keys()), command=change_button_color)
box_color_hbtn = CTkComboBox(master=fram_color_hover, values=list(col_hbtn.keys()), command=change_hover_color)
box_color_tbtn = CTkComboBox(master=fram_color_text, values=list(col_tbtn.keys()), command=change_text_color)
scroll_color_btn = CTkScrollableDropdown(box_color_btn, values=list(col_btn.keys()), justify="left", button_color="transparent", frame_corner_radius= 10, height=120, command=change_button_color)
scroll_color_hbtn = CTkScrollableDropdown(box_color_hbtn, values=list(col_hbtn.keys()), justify="left", button_color="transparent", frame_corner_radius= 10, height=100, command=change_hover_color)
scroll_color_tbtn = CTkScrollableDropdown(box_color_tbtn, values=list(col_tbtn.keys()), justify="left", button_color="transparent", frame_corner_radius= 10, height=71, command=change_text_color)
